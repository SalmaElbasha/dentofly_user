...
class _OfferProductListScreenState extends State<OfferProductListScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<ProductController>(context, listen: false).getDiscountedProductList(1, context,false);
        ...
        builder: (context, productController, child) {
          ...
          return (productController.discountedProductModel?.products?.isNotEmpty ?? false) ? Padding(
            ...
            child: PaginatedListView(
              ...
              onPaginate: (int? offset) async => await productController.getDiscountedProductList(offset ?? 1, context,false),
              itemView: Expanded(
