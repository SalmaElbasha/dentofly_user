  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(AppConstants.appName,style: textRegular.copyWith(fontSize: Dimensions.fontSizeOverLarge, color:const Color(0xff043551))),
        Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
            child: Text(AppConstants.slogan,style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: const Color(0xff043551))))]),
