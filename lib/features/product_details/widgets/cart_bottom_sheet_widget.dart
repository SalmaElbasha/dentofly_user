...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
                ...
                Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall),
                      child: Text('(${getTranslated('tax', context)} ${Provider.of<CartController>(context, listen: false).serviceFees})',
  ...
  void _navigateToCheckoutScreen(BuildContext context, CartModel cart, double shippingCost)async{
    await Provider.of<CartController>(context, listen: false).getSeviceFees();
    ...
    double tax = (Provider.of<CheckoutController>(context, listen: false).serviceFees??0);
    double shippingAmount = (Provider.of<AddressController>(context, listen: false).shippingCost??0

   );


      tax =Provider.of<CartController>(context, listen: false).serviceFees??0;
