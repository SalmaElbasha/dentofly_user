...
import '../../product/domain/models/product_model.dart'as pm;
...
class RefundBottomSheet extends StatefulWidget {
  ...
  const RefundBottomSheet({super.key,  this.product, required this.orderDetailsId, required this.orderId, });
