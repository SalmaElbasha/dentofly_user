                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(onTap: (){
                            if(widget.fromCompare){
                              ...
                              searchProvider.searchProduct(query : option.toString(), offset: 1, context: context);
                ...
                fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                  ...
                  return Hero(
                    ...
                    child: Material(child: TextFormField(
                        ...
                        onChanged: (val){
                          if(val.isNotEmpty){
                            searchProvider.getSuggestionProductName(context,searchProvider.searchController.text.trim());
                          }
                        },
                        onFieldSubmitted: (value) {
                          if(controller.text.trim().isNotEmpty) {
                            searchProvider.saveSearchAddress( controller.text.toString());
                            searchProvider.searchProduct(query : controller.text.toString(), offset: 1, context: context);
                          }else{
