...
class ShippingDetailsWidget extends StatefulWidget {
  ...
  final GlobalKey<FormState> passwordFormKey;
   ...
   ShippingDetailsWidget({super.key, required this.hasPhysical, required this.billingAddress, required this.passwordFormKey, required this.cartList, required this.fromProductDetails, required this.totalOrderAmount, required this.shippingFee, required this.discount, this.sellerId, required this.onlyDigital, required this.quantity});
