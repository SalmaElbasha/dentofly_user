                  ...
                  child: Row(children: List<Widget>.generate(searchProductController.publishingHouseList!.length, (index){
                    return InkWell(splashColor: Colors.transparent, highlightColor: Colors.transparent,
                      onTap: () {
                        ...
                        Provider.of<SearchProductController>(context, listen: false).searchProduct( query : '', offset:1,  publishingIds: Provider.of<SearchProductController>(context, listen: false).publishingHouseIds.toString(), context: context);
