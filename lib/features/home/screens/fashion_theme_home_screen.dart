...
class FashionThemeHomePage extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload,BuildContext context) async {
    ...
    shopController.getAllSellerList(reload, 1,context, type: "all");
    ...
    productController.getFeaturedProductList('1',context, reload: reload);
    ...
    productController.getMostDemandedProduct(context);

    productController.getMostSearchingProduct(1,context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(resizeToAvoidBottomInset: false,
      body: SafeArea(child: RefreshIndicator(
          onRefresh: () async {
            await FashionThemeHomePage.loadData( true,context);
                                ...
                                itemBuilder: (context, index){
                                  return InkWell(
                                    onTap: ()=> productController.changeTypeOfProduct(productController.productTypeList[index].productType,
                                      productController.productTypeList[index].title,context, index: index),
