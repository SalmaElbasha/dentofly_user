...
class OrderAmountCalculation extends StatelessWidget {
  ...
  const OrderAmountCalculation({super.key, required this.itemTotalAmount, required this.discount, this.eeDiscount, required this.tax, required this.shippingCost, required this.orderProvider, required this.shippingFees});
    ...
    return  Container(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          AmountWidget(title: getTranslated('sub_total', context),
              amount: PriceConverter.convertPrice(context, itemTotalAmount-shippingFees)),
          ...
          AmountWidget(title: getTranslated('service_fee', context),
              amount: PriceConverter.convertPrice(context, shippingFees)),
          ...
          AmountWidget(title: getTranslated('total_payable', context),
            amount: PriceConverter.convertPrice(context, (itemTotalAmount + shippingCost - eeDiscount! - orderProvider.orders!.discountAmount! - discount  )),),
