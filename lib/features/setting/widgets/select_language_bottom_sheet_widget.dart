          ...
          child: Container(padding: const EdgeInsets.only(bottom: 40, top: 15),
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(padding: const EdgeInsets.fromLTRB( Dimensions.paddingSizeSmall, Dimensions.paddingSizeSmall,
                ...
                child: CustomButton(buttonText: '${getTranslated('select', context)}', onTap: () async {
                  ...
                  Provider.of<ProductController>(context, listen: false).getHomeCategoryProductList(context,true);
                  Provider.of<ShopController>(context, listen: false).getTopSellerList(true, 1,context, type: "top");
                  ...
                  Provider.of<ProductController>(context, listen: false).getFeaturedProductList('1',context, reload: true);
                  Provider.of<FeaturedDealController>(context, listen: false).getFeaturedDealList(true,context);
                  Provider.of<ProductController>(context, listen: false).getLProductList('1',context, reload: true);
