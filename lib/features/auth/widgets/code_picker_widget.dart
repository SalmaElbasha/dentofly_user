      ...
      builder: (context) => Center(
        child: Dialog(
          child: SelectionDialog(
            ...
            flagDecoration: widget.flagDecoration, hideHeaderText: false,headerAlignment: MainAxisAlignment.start, // or choose center / end as needed
            headerTextStyle: const TextStyle(), // or provide your custom style
