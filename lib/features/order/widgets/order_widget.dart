    ...
    if(orderModel?.orderType == 'POS') {
      ...
      if (orderModel?.details != null && orderModel!.details!.isNotEmpty ) {
        ...
        for (var orderDetails in orderModel!.details!) {
          ...
          tax = double.tryParse(orderModel?.serviceFee??"")??0;
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(flex: 5,
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(PriceConverter.convertPrice(context, orderModel!.orderType == 'POS' ? orderAmount :( orderModel?.orderAmount??0)+(double.tryParse(orderModel?.serviceFee??"")??0)+(orderModel?.shippingCost??0)),
