...
class CategoryController extends ChangeNotifier {
  ...
  Future<void> resetChecked(int? id, bool fromShop,BuildContext context) async{
    if(fromShop){
      await getSellerWiseCategoryList(id!);
      Provider.of<BrandController>(Get.context!, listen: false).getSellerWiseBrandList(id);
      Provider.of<SellerProductController>(Get.context!, listen: false).getSellerProductList(id.toString(), 1, "",context: context);
    }else{
