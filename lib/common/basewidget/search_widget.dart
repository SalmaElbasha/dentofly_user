              ...
              child: Padding(padding:  const EdgeInsets.symmetric(
                ...
                child: TextFormField(controller: searchController,
                    ...
                    onFieldSubmitted: (val){
                      sellerProductController.getSellerProductList(widget.sellerId.toString(), 1, "", search: searchController.text.trim(),context: context);
                    },
                    onChanged: (val){
                  setState(() {
                      ...
                      suffixIcon: searchController.text.isNotEmpty? InkWell(
                        onTap: (){
                          setState(() {
                            ...
                            sellerProductController.getSellerProductList(widget.sellerId.toString(), 1, "",context: context);
