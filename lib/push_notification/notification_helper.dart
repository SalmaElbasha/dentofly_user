...
class NotificationHelper {
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      if (kDebugMode) {
        ...
        if(message.data['type'] == "block"&&message.data['type'] != 'demo_reset'){
      ...
      if(message.data['type'] == 'maintenance_mode'&&message.data['type'] != 'demo_reset') {
      ...
      if(message.data['type'] != 'maintenance_mode' || message.data['type'] != 'product_restock_update'&&message.data['type'] != 'demo_reset') {
        NotificationHelper.showNotification(message, flutterLocalNotificationsPlugin, false);
      }

      if(message.data['type'] == 'product_restock_update' && !Provider.of<RestockController>(Get.context!, listen: false).isBottomSheetOpen&&message.data['type'] != 'demo_reset'){
  ...
  static Future<void> showTextNotification(String title, String body, String orderID, NotificationBody? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'Dentofly', 'Dentofly', playSound: true,
  ...
  static Future<void> showBigTextNotification(String? title, String body, String? orderID, NotificationBody? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'Dentofly', 'Dentofly', importance: Importance.max,
